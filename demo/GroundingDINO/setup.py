...
torch_ver = [int(x) for x in torch.__version__.split(".")[:2]] if torch else [2, 0]


def get_extensions():
    if torch is None or CppExtension is None:
        return []
...
if __name__ == "__main__":
    ...
    setup(
        ...
        cmdclass={"build_ext": torch.utils.cpp_extension.BuildExtension} if torch else {},
    )
